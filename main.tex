...
Thus, biosensors provide a solution to many of the problems inherent to metabolite extraction and LCMS, with the trade-off of monitoring only one metabolite per sensor.
...
To shift the relative affinities of the two ligands, we looked at the structure of the binding pocket  \citep{Hu2008-nd}, and sampled all possible amino acid substitutions of residue S72, which interacts with the side-chain carboxylate of bound glutamate (\FIG{Fig1}, panel A).
...
A recently reported and concurrently developed sensor for aspartate is reported to be adversely effected by temperatures higher than 30˚C, causing lower maximum ∆F/F.
