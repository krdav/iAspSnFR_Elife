...
\label{fig:Fig1}
\figsupp{qwerty}{\fbox{\includegraphics[width=0.98\linewidth]{figures/Fig1S1.pdf}}}
\figsupp{qwerty}{\fbox{\includegraphics[width=0.98\linewidth]{figures/Fig1S2.pdf}}}
\end{figure}
...
Related to panel A in \FIG{Fig2}; however, these experiments are not normalized to a pre-treatment scan.
...
}{\fbox{\includegraphics[width=0.98\linewidth]{figures/Fig2S1.pdf}}}
\figsupp{
...
Identical to panel E \FIG{Fig2} but with more well replicates.
}{\fbox{\includegraphics[width=0.5\linewidth]{figures/Fig2S2.pdf}}}
\end{figure}
...
\label{fig:Fig3}
\figsupp{
Arbitrary unit (AU) RFP normalized iAspSnFR signal at steady-state, following various perturbations to live cells, is not correlated with the LCMS measured intracellular glutamate concentration.
...
}{\fbox{\includegraphics[width=0.98\linewidth]{figures/Fig3S1.pdf}}}
\end{figure}
