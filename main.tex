...
In bacterial cell lysate, S72P maintained the expected shift to a preference for aspartate when deriving from the iGluSnFR3 scaffold, and had a higher fluorescence fold increase (∆F/F) than either S72A or S72T (\FIGSUPP[Fig1]{f1S1}, panel A).
