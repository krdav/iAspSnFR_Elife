...
(C) jAspSnFR3-mRuby3 does not respond to other decoys: citrate, lactate, pyruvate, malate, alpha-ketoglutarate, cis-aconitate, succinate, fumarate, or oxaloacetate (orange squares); nor to relevant pharmacological treatments: rotenone (green squares) or metformin.
...
Ex. 485 nm (20 nm bandpass), Em. 535 nm (20 nm bandpass).
(D) jAspSnFR3-mRuby3 is not adversely affected by temperature.
...
(E) pH sensitivity of jAspSnFR3-mRuby3 (green component).
...
}{\fbox{\includegraphics[width=0.98\linewidth]{Fig1S2.pdf}}}\label{figsupp:f1S2}
\end{figure}
...
We also noted that normalization with nuclear RFP and RFP fusion were highly correlated, enabling jAspSnFR3 sensor applications where nuclear RFP labeling is desirable e.g. for counting cells at multiple timepoints using live cell imaging (\FIGSUPP[Fig2]{f2S1}, panel C).
...
% Furthermore, we tested and confirmed the ability of pyruvate to rescue aspartate levels after an initial depletion phase (suppl. figure).
...
% Finally, we evaluated the ability of limiting synthesis to cause Asp depletion (Gln) [figure]
...
RFP normalized jAspSnFR3 signal change over time following rotenone treatment of live cells.
...
(A) HT1080 cells using nuclear RFP to normalize the jAspSnFR3 signal.
(B) HT1080 cells using an RFP fused to jAspSnFR3 (jAspSnFR3-mRuby3) for normalization.
...
(D) HEK293t cells using an RFP fused to jAspSnFR3 for normalization.
...
RFP normalized jAspSnFR3 signal change over time following glutamine depletion in H1299 cells.
Identical to \FIG{Fig2}, panel F but with fewer glutamine concentrations and more well replicates.
AU, arbitrary unit.
}{\fbox{\includegraphics[width=0.65\linewidth]{Fig2S2.pdf}}}\label{figsupp:f2S2}
\end{figure}


% \subsubsection{Oligomycin induced decrease in aspartate can be rescued by uncoupling the mitochondrial embrane potential}
% blaa, new figure
