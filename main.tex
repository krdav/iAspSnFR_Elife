...
%KD: Do I understand this correctly: The S72X mutation screen was done on a precursor to iGluSnFR3, then iGluSnFR3 was developed and the best S72X mutations was transplated onto this scaffold and that is what is plotted in Fig1 S1?
...
%KD: Theirs is based on SF-iGluSnFR ours is based on iGluSnFR3 (right?). Maybe we should make that clear.
